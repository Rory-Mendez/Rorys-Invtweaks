...
5. Packages `build/classes/` into `build/libs/rorys-invtweaks-0.0.1.zip`.

On success:

```
Build successful: build\libs\rorys-invtweaks-0.0.1.zip
```
...
cd build/classes
jar cMf ../../build/libs/rorys-invtweaks-0.0.1.zip .
```
